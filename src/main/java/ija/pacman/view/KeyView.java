/**
 * @file KeyView.java
 * @brief Class for painting key on field in UI
...
public class KeyView implements NodeView {
    ...
    public void paintNode(GraphicsContext g) {
        ...
        File file = new File(System.getProperty("user.dir") + File.separator + "lib" + File.separator + "icons" + File.separator + "key.png");
